...
from clients.exercises.exercises_client import get_private_exercises_client, CreateExerciseRequestBody
...
create_exercise_request = CreateExerciseRequestBody(
    title='title',
