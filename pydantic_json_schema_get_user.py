...
from clients.users.users_schema import CreateUserRequestSchema, GerUserResponseSchema
...
get_user_response_schema = GerUserResponseSchema.model_json_schema() # Генерируем JSON-схему для ожидаемого ответа
